...
<template>
  <div class="homePage-grid">
    <h1 class="text-center" style="margin-top: 0.5em">Jelenleg a <i><strong>{{ profiles.name }}</strong></i> nevű
      profilban vagy.</h1>
    <h1 class="text-center" style="margin-top: 0.5em;margin-bottom:1em; ">Egyenleged: <i><strong>{{ expenseList.balance }}
          {{ expenseList.currencyCode }}</strong></i></h1>
