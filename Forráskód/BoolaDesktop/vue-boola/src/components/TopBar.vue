...
<template>
    <div class="TopBar-container unselectable">
        <span v-if="MenuStore.isMainMenuDisplayed" @click="MenuStore.toggleMainMenu" class="material-symbols-outlined size-32 btn-menu-toggle icon-hover-highlight" :class="`${MenuStore.isMainMenuOpened && '' /*'btn-menu-move'*/}`">menu</span>
